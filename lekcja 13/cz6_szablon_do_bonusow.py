...
def limit_position(player_pos):
    # TODO
    return player_pos


def generate_bonus_object():
    # Wylosowanie nazwy pliku z ikonką do wczytania
    # TODO

    # Wylosowanie współrzędnych dla nowego obiektu
    # TODO

    # Utworzenie zmiennej position z pozycją nowego elementu
    # TODO

    # Utworzenie grafiki za pomocą funkcji load_image
    # TODO

    # Dodanie gotowego obiektu bonusowego do listy wszystkich elementów
    # TODO
